...
class PlayerSprites extends ThemedSprites {
  static SPRITES = {
    ...
    jumpRight: [
      ...
      new Sprite(new Vector(146, 425), new Vector(17, 15), -5),
      new Sprite(new Vector(184, 421), new Vector(14, 17), -6),
    ...
    jumpLeft: [
      ...
      new Sprite(new Vector(152, 466), new Vector(17, 15), -5),
      new Sprite(new Vector(187, 462), new Vector(14, 17), -6),
